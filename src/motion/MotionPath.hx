...
class MotionPath {
	 ...
	 */
	public function bezier(x:Float, y:Float, controlX:Float, controlY:Float, strength = 1.):MotionPath {
	 ...
	 * @return		The current motion path instance
	 */
	public function bezierN(x:Float, y:Float, controlX:Array<Float>, controlY:Array<Float>, strength = 1.):MotionPath {
	 ...
	 * @return		The current motion path instance
	 */
	public function line(x:Float, y:Float, strength = 1.):MotionPath {
	...
	@:noCompletion inline function get_x():IComponentPath {
		return _x;
	}

	@:noCompletion inline function get_y():IComponentPath {
		return _y;
	}
}
...
class ComponentPath implements IComponentPath {
	...
	var paths:Array<IComponentPath>;
	...
	// Get & Set Methods
	@:noCompletion function get_start():Float {
